;(function (global, factory) {
    ...
    hooks.defineLocale('az', {
        ...
        weekdays:
            'Bazar_Bazar ert?si_Ç?r??nb? ax?am?_Ç?r??nb?_Cüm? ax?am?_Cüm?_??nb?'.split(
                '_'
            ),
        weekdaysShort: 'Baz_BzE_ÇAx_Ç?r_CAx_Cüm_??n'.split('_'),
        weekdaysMin: 'Bz_BE_ÇA_Ç?_CA_Cü_??'.split('_'),
        weekdaysParseExact: true,
        longDateFormat: {
            LT: 'HH:mm',
            LTS: 'HH:mm:ss',
        ...
        meridiemParse: /gec?|s?h?r|gündüz|ax?am/,
        isPM: function (input) {
            return /^(gündüz|ax?am)$/.test(input);
        },
        meridiem: function (hour, minute, isLower) {
            if (hour < 4) {
                return 'gec?';
        ...
        dayOfMonthOrdinalParse: /\d{1,2}-(?nc?|inci|nci|üncü|nc?|uncu)/,
        ordinal: function (number) {
            if (number === 0) {
    ...
    var months$4 = {
            format: 'leden_únor_b?ezen_duben_kv?ten_?erven_?ervenec_srpen_zá?í_?íjen_listopad_prosinec'.split(
                '_'
            ),
            standalone:
                'ledna_února_b?ezna_dubna_kv?tna_?ervna_?ervence_srpna_zá?í_?íjna_listopadu_prosince'.split(
                    '_'
                ),
        },
        monthsShort = 'led_úno_b?e_dub_kv?_?vn_?vc_srp_zá?_?íj_lis_pro'.split('_'),
        monthsParse$1 = [
            /^led/i,
            /^úno/i,
            /^b?e/i,
        ...
        monthsRegex$2 =
            /^(leden|únor|b?ezen|duben|kv?ten|?ervenec|?ervence|?erven|?ervna|srpen|zá?í|?íjen|listopad|prosinec|led|úno|b?e|dub|kv?|?vn|?vc|srp|zá?|?íj|lis|pro)/i;
    ...
    function translate$1(number, withoutSuffix, key, isFuture) {
        ...
        switch (key) {
            ...
            case 'M': // a month / in a month / a month ago
                return withoutSuffix || isFuture ? 'm?síc' : 'm?sícem';
            case 'MM': // 9 months / in 9 months / 9 months ago
                if (withoutSuffix || isFuture) {
                    return result + (plural$1(number) ? 'm?síce' : 'm?síc?');
                } else {
                    return result + 'm?síci';
                }
    ...
    hooks.defineLocale('cs', {
        ...
        // Otherwise parser matches '1. ?ervenec' as '1. ?erven' + 'ec'.
        monthsStrictRegex:
            /^(leden|ledna|února|únor|b?ezen|b?ezna|duben|dubna|kv?ten|kv?tna|?ervenec|?ervence|?erven|?ervna|srpen|srpna|zá?í|?íjen|?íjna|listopadu|listopad|prosinec|prosince)/i,
        monthsShortStrictRegex:
            /^(led|úno|b?e|dub|kv?|?vn|?vc|srp|zá?|?íj|lis|pro)/i,
        monthsParse: monthsParse$1,
        longMonthsParse: monthsParse$1,
        shortMonthsParse: monthsParse$1,
        weekdays: 'ned?le_pond?lí_úterý_st?eda_?tvrtek_pátek_sobota'.split('_'),
    ...
    var weekEndings =
        'vasárnap hétf?n kedden szerdán csütörtökön pénteken szombaton'.split(' ');
    ...
    hooks.defineLocale('hu', {
        ...
        monthsParseExact: true,
        weekdays: 'vasárnap_hétf?_kedd_szerda_csütörtök_péntek_szombat'.split('_'),
    ...
    hooks.defineLocale('ro', {
        ...
        monthsParseExact: true,
        weekdays: 'duminic?_luni_mar?i_miercuri_joi_vineri_sâmb?t?'.split('_'),
    ...
    hooks.defineLocale('se', {
        months: 'o??ajagemánnu_guovvamánnu_njuk?amánnu_cuo?ománnu_miessemánnu_geassemánnu_suoidnemánnu_borgemánnu_?ak?amánnu_golggotmánnu_skábmamánnu_juovlamánnu'.split(
            '_'
        ),
        monthsShort:
            'o??j_guov_njuk_cuo_mies_geas_suoi_borg_?ak?_golg_skáb_juov'.split('_'),
        weekdays:
            'sotnabeaivi_vuossárga_ma??ebárga_gaskavahkku_duorastat_bearjadat_lávvardat'.split(
                '_'
            ),
    ...
    hooks.defineLocale('tk', {
        ...
        weekdays: 'Ýek?enbe_Du?enbe_Si?enbe_Çar?enbe_Pen?enbe_Anna_?enbe'.split(
            '_'
        ),
        weekdaysShort: 'Ýek_Du?_Si?_Çar_Pen_Ann_?en'.split('_'),
        weekdaysMin: 'Ýk_D?_S?_Çr_Pn_An_?n'.split('_'),
        longDateFormat: {
            LT: 'HH:mm',
            LTS: 'HH:mm:ss',
            L: 'DD.MM.YYYY',
    ...
    hooks.defineLocale('tr', {
        months: 'Ocak_?ubat_Mart_Nisan_May?s_Haziran_Temmuz_A?ustos_Eylül_Ekim_Kas?m_Aral?k'.split(
            '_'
        ),
        monthsShort: 'Oca_?ub_Mar_Nis_May_Haz_Tem_A?u_Eyl_Eki_Kas_Ara'.split('_'),
        weekdays: 'Pazar_Pazartesi_Sal?_Çar?amba_Per?embe_Cuma_Cumartesi'.split(
            '_'
        ),
    ...
    hooks.defineLocale('vi', {
        ...
        monthsParseExact: true,
        weekdays: 'ch? nh?t_th? hai_th? ba_th? t?_th? n?m_th? sáu_th? b?y'.split(
            '_'
        ),
